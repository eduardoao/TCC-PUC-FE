...
@Component({
  selector: 'app-ocorrenciaarmafogo',
  templateUrl: './ocorrenciaarmafogo.component.html',
  styleUrls: ['./ocorrenciaarmafogo.component.css']
})
export class OcorrenciaarmafogoComponent implements OnInit {
...
retornarDadosHomicidio(){
  ...
  .subscribe( (criminalidade) => {   
    this.homicidio = criminalidade.filter(t => t.tipo == "Roubo")
